...
- scanning for possible obstacles
...
### Installation
można to zmienić na jakieś pobieranie czy coś. Zasadniczo "jak zaimportować projekt"
### Running examples
tutaj że mamy ileś gotowych przykładów i jak je odpalić (najlepiej z wersją z konsoli)
```sh
$ jakaś instrukcja
```
### Map creation
że trzeba ręcznie (chyba, że nie trzeba?) + jakie funkcje wywołać, żeby zrobiły się komórki i ścieżki
w tym i poniższych najlepiej dodać przykłady kodu
### Cars generation
jak dodać auto na wybranym końcu drogi, jak generować je co jakiś czas, losowo itp
### Ascribing paths
jak prawidłowo dodać autu ścieżki, ewentualnie mechanizm losowania ścieżki dla auta startującego z danej pozycji (losowo wybrać między trzema trasami: skręci w prawo, skręci w lewo, pojedzie prosto) - byłaby potrzebna możliwość losowania trasy spośród zaczynających się w danym punkcie
### Adding traffic lights
jak prawidłowo dodać i skonfigurować światła
### Adding obstacles
jak dodać przeszkodę
### Simulation
